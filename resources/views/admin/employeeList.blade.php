            ...
            <table class="min-w-full divide-y divide-slate-200">
                <thead class="bg-blue-50">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3 text-center text-xs font-bold text-blue-800 uppercase tracking-wider">Name</th>
                        <th scope="col" class="px-6 py-3 text-center text-xs font-bold text-blue-800 uppercase tracking-wider">Role</th>
                        <th scope="col" class="px-6 py-3 text-center text-xs font-bold text-blue-800 uppercase tracking-wider">Action</th>
                    </tr>
                </thead>
